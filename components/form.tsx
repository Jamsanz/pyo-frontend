...
const Form = () => {
  return (
    <div className='flex flex-1' id="member">
      ...
      <form className='w-full md:w-1/2 inline-flex flex-col space-y-4' action="">
        <input
          type="text"
          placeholder='First Name'
          className='w-full md:w-1/3 py-[0.66em] px-[1.33em] border-[#d4d4d4] bg-white'
        />
        <input
          type="text"
        ...
        <input
          ...
          className='w-full md:w-1/3 py-[0.66em] px-[1.33em] border-[#d4d4d4] bg-white'
        />
        <select className='w-full md:w-1/3 py-[0.66em] px-[1.33em] border-[#d4d4d4] bg-white'>
