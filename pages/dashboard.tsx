    ...
    <DashboardLayout pageName="dashboard">
      <div className="bg-[#f4f4f4] min-h-screen py-3 flex flex-col">
        ...
        <div className="lg:flex-1 mx-3 mt-12 lg:mt-0 overflow-x-auto">
          ...
          {
            loading && <div className="h-[200px] w-full flex justify-center items-center">
              Loading...
            </div>
          }
          {
            ...
            <div className='w-full h-[200px] flex flex-col space-y-2 justify-center items-center'>
                ...
                <button className="p-3 bg-[#1F2937] text-white rounded-md">
                  Schedule Event <i className="fa-solid fa-calendar ml-1 text-white"></i>
                </button>
            </div>
          }
          {
              ...
              <tbody className='overflow-x-scroll'>
                {
                  schedules?.map((schedule, index) => (
                    <tr className='bg-white border-b' key={index}>
                      ...
                      <td className='px-6 py-4'>{schedule.status ? 'approved' : 'unapproved'} </td>
