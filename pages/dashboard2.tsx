...
const Dashboard = () => {
  ...
  return (
    <div>
      <nav className="fixed z-30 w-full bg-black border-b-2 border-indigo-600">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="#" className="flex items-center text-xl font-bold">
                <span className="text-[#fff]">Logo</span>
              </a>
            </div>
      ...
      <div className="pt-12 lg:flex fixed">
          ...
          <div className="flex flex-col justify-between mt-6">
            <aside>
              <ul>
                <li>
                  <a
                    className="flex items-center px-[4px] py-2 text-gray-700 bg-gray-100 rounded-md "
                    href="#"
                  >
        ...
        <div className="w-[100%] h-full p-4 m-8 overflow-y-auto text-center mx-auto">
          <h2 className="text-[#000]"> Welcome </h2>
